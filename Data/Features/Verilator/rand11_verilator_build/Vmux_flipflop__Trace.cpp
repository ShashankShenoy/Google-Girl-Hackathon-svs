...
void Vmux_flipflop::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vmux_flipflop::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vmux_flipflop__Syms* __restrict vlSymsp = static_cast<Vmux_flipflop__Syms*>(userp);
    Vmux_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void Vmux_flipflop::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vmux_flipflop__Syms* __restrict vlSymsp = static_cast<Vmux_flipflop__Syms*>(userp);
    Vmux_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
