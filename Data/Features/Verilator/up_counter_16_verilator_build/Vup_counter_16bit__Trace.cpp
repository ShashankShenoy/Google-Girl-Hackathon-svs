...
void Vup_counter_16bit::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vup_counter_16bit::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vup_counter_16bit__Syms* __restrict vlSymsp = static_cast<Vup_counter_16bit__Syms*>(userp);
    Vup_counter_16bit* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void Vup_counter_16bit::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vup_counter_16bit__Syms* __restrict vlSymsp = static_cast<Vup_counter_16bit__Syms*>(userp);
    Vup_counter_16bit* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
