...
void Vand_nand_flipflop::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vand_nand_flipflop::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vand_nand_flipflop__Syms* __restrict vlSymsp = static_cast<Vand_nand_flipflop__Syms*>(userp);
    Vand_nand_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void Vand_nand_flipflop::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vand_nand_flipflop__Syms* __restrict vlSymsp = static_cast<Vand_nand_flipflop__Syms*>(userp);
    Vand_nand_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
