...
void Vsequence_detector_1010::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+2,"sequence_detector_1010 reset", false,-1);
        tracep->declBit(c+3,"sequence_detector_1010 data_in", false,-1);
        tracep->declBit(c+4,"sequence_detector_1010 detected", false,-1);
        tracep->declBus(c+7,"sequence_detector_1010 S0", false,-1, 1,0);
        tracep->declBus(c+8,"sequence_detector_1010 S1", false,-1, 1,0);
        tracep->declBus(c+9,"sequence_detector_1010 S2", false,-1, 1,0);
        tracep->declBus(c+10,"sequence_detector_1010 S3", false,-1, 1,0);
        tracep->declBus(c+5,"sequence_detector_1010 current_state", false,-1, 1,0);
        tracep->declBus(c+6,"sequence_detector_1010 next_state", false,-1, 1,0);
    }
}
...
void Vsequence_detector_1010::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+5,(vlTOPp->sequence_detector_1010__DOT__current_state),2);
        tracep->fullCData(oldp+6,(vlTOPp->sequence_detector_1010__DOT__next_state),2);
