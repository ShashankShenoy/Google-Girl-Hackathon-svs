...
void Vnor_and_nand_flipflop::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vnor_and_nand_flipflop::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vnor_and_nand_flipflop__Syms* __restrict vlSymsp = static_cast<Vnor_and_nand_flipflop__Syms*>(userp);
    Vnor_and_nand_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void Vnor_and_nand_flipflop::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vnor_and_nand_flipflop__Syms* __restrict vlSymsp = static_cast<Vnor_and_nand_flipflop__Syms*>(userp);
    Vnor_and_nand_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
