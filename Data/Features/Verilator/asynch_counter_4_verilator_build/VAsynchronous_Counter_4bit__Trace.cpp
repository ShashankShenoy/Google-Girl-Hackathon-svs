...
void VAsynchronous_Counter_4bit::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VAsynchronous_Counter_4bit::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VAsynchronous_Counter_4bit__Syms* __restrict vlSymsp = static_cast<VAsynchronous_Counter_4bit__Syms*>(userp);
    VAsynchronous_Counter_4bit* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VAsynchronous_Counter_4bit::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VAsynchronous_Counter_4bit__Syms* __restrict vlSymsp = static_cast<VAsynchronous_Counter_4bit__Syms*>(userp);
    VAsynchronous_Counter_4bit* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
