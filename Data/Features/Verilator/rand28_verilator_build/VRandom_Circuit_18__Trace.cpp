...
void VRandom_Circuit_18::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VRandom_Circuit_18::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VRandom_Circuit_18__Syms* __restrict vlSymsp = static_cast<VRandom_Circuit_18__Syms*>(userp);
    VRandom_Circuit_18* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VRandom_Circuit_18::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VRandom_Circuit_18__Syms* __restrict vlSymsp = static_cast<VRandom_Circuit_18__Syms*>(userp);
    VRandom_Circuit_18* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
