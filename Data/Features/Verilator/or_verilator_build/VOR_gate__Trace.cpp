...
void VOR_gate::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VOR_gate::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VOR_gate__Syms* __restrict vlSymsp = static_cast<VOR_gate__Syms*>(userp);
    VOR_gate* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VOR_gate::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VOR_gate__Syms* __restrict vlSymsp = static_cast<VOR_gate__Syms*>(userp);
    VOR_gate* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
