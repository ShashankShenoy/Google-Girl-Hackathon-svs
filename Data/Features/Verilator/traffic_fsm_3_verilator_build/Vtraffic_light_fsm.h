...
VL_MODULE(Vtraffic_light_fsm) {
  public:
    ...
    CData/*3:0*/ traffic_light_fsm__DOT__timer;
    ...
    static CData/*1:0*/ __Vtable1_traffic_light_fsm__DOT__current_state[128];
    static CData/*3:0*/ __Vtable1_traffic_light_fsm__DOT__timer[128];
