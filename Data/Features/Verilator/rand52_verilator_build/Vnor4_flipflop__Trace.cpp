...
void Vnor4_flipflop::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vnor4_flipflop::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vnor4_flipflop__Syms* __restrict vlSymsp = static_cast<Vnor4_flipflop__Syms*>(userp);
    Vnor4_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void Vnor4_flipflop::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vnor4_flipflop__Syms* __restrict vlSymsp = static_cast<Vnor4_flipflop__Syms*>(userp);
    Vnor4_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
