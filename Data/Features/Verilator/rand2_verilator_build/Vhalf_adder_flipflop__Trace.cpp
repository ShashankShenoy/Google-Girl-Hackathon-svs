...
void Vhalf_adder_flipflop::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vhalf_adder_flipflop::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vhalf_adder_flipflop__Syms* __restrict vlSymsp = static_cast<Vhalf_adder_flipflop__Syms*>(userp);
    Vhalf_adder_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    ...
    // Body
    {
        ...
        tracep->chgBit(oldp+4,(vlTOPp->sum_out));
...
void Vhalf_adder_flipflop::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vhalf_adder_flipflop__Syms* __restrict vlSymsp = static_cast<Vhalf_adder_flipflop__Syms*>(userp);
    Vhalf_adder_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
