...
void Vnand_mux_flipflop::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vnand_mux_flipflop::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vnand_mux_flipflop__Syms* __restrict vlSymsp = static_cast<Vnand_mux_flipflop__Syms*>(userp);
    Vnand_mux_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    ...
    // Body
    {
        ...
        tracep->chgBit(oldp+6,((1U & (~ ((IData)(vlTOPp->a) 
                                         & (IData)(vlTOPp->b))))));
        tracep->chgBit(oldp+7,((1U & ((IData)(vlTOPp->sel)
                                       ? (~ ((IData)(vlTOPp->a) 
                                             & (IData)(vlTOPp->b)))
                                       : (IData)(vlTOPp->a)))));
    }
...
void Vnand_mux_flipflop::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vnand_mux_flipflop__Syms* __restrict vlSymsp = static_cast<Vnand_mux_flipflop__Syms*>(userp);
    Vnand_mux_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
