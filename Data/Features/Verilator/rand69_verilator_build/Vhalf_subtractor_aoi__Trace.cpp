...
void Vhalf_subtractor_aoi::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vhalf_subtractor_aoi::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vhalf_subtractor_aoi__Syms* __restrict vlSymsp = static_cast<Vhalf_subtractor_aoi__Syms*>(userp);
    Vhalf_subtractor_aoi* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void Vhalf_subtractor_aoi::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vhalf_subtractor_aoi__Syms* __restrict vlSymsp = static_cast<Vhalf_subtractor_aoi__Syms*>(userp);
    Vhalf_subtractor_aoi* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
