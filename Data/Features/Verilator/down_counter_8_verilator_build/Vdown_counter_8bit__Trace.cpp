...
void Vdown_counter_8bit::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vdown_counter_8bit::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vdown_counter_8bit__Syms* __restrict vlSymsp = static_cast<Vdown_counter_8bit__Syms*>(userp);
    Vdown_counter_8bit* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void Vdown_counter_8bit::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vdown_counter_8bit__Syms* __restrict vlSymsp = static_cast<Vdown_counter_8bit__Syms*>(userp);
    Vdown_counter_8bit* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
