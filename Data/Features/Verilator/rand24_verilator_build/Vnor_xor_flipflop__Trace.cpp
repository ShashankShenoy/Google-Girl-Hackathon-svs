...
void Vnor_xor_flipflop::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vnor_xor_flipflop::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vnor_xor_flipflop__Syms* __restrict vlSymsp = static_cast<Vnor_xor_flipflop__Syms*>(userp);
    Vnor_xor_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void Vnor_xor_flipflop::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vnor_xor_flipflop__Syms* __restrict vlSymsp = static_cast<Vnor_xor_flipflop__Syms*>(userp);
    Vnor_xor_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
