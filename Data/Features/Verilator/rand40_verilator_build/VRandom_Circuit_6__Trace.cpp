...
void VRandom_Circuit_6::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VRandom_Circuit_6::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VRandom_Circuit_6__Syms* __restrict vlSymsp = static_cast<VRandom_Circuit_6__Syms*>(userp);
    VRandom_Circuit_6* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VRandom_Circuit_6::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VRandom_Circuit_6__Syms* __restrict vlSymsp = static_cast<VRandom_Circuit_6__Syms*>(userp);
    VRandom_Circuit_6* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
