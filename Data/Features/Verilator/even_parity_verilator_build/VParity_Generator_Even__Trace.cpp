...
void VParity_Generator_Even::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VParity_Generator_Even::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VParity_Generator_Even__Syms* __restrict vlSymsp = static_cast<VParity_Generator_Even__Syms*>(userp);
    VParity_Generator_Even* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VParity_Generator_Even::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VParity_Generator_Even__Syms* __restrict vlSymsp = static_cast<VParity_Generator_Even__Syms*>(userp);
    VParity_Generator_Even* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
