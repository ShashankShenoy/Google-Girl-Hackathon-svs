...
void Vnand_xnor_flipflop::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vnand_xnor_flipflop::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vnand_xnor_flipflop__Syms* __restrict vlSymsp = static_cast<Vnand_xnor_flipflop__Syms*>(userp);
    Vnand_xnor_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void Vnand_xnor_flipflop::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vnand_xnor_flipflop__Syms* __restrict vlSymsp = static_cast<Vnand_xnor_flipflop__Syms*>(userp);
    Vnand_xnor_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
