...
void Vupdown_counter_8bit::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vupdown_counter_8bit::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vupdown_counter_8bit__Syms* __restrict vlSymsp = static_cast<Vupdown_counter_8bit__Syms*>(userp);
    Vupdown_counter_8bit* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    ...
    // Body
    {
        ...
        tracep->chgCData(oldp+4,(vlTOPp->count),8);
    }
}

void Vupdown_counter_8bit::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vupdown_counter_8bit__Syms* __restrict vlSymsp = static_cast<Vupdown_counter_8bit__Syms*>(userp);
    Vupdown_counter_8bit* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
