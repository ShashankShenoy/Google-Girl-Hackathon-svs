...
void Vnand_or_buffer_flipflop::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void Vnand_or_buffer_flipflop::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    Vnand_or_buffer_flipflop__Syms* __restrict vlSymsp = static_cast<Vnand_or_buffer_flipflop__Syms*>(userp);
    Vnand_or_buffer_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void Vnand_or_buffer_flipflop::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    Vnand_or_buffer_flipflop__Syms* __restrict vlSymsp = static_cast<Vnand_or_buffer_flipflop__Syms*>(userp);
    Vnand_or_buffer_flipflop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
